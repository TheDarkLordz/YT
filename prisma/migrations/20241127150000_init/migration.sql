-- CreateEnum
CREATE TYPE "IdeaStatus" AS ENUM ('DRAFT', 'RESEARCHING', 'VALIDATED', 'SHELVED');
...
ALTER TABLE "ComparisonSet" ADD CONSTRAINT "ComparisonSet_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
